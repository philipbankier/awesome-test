...
Curated links for the multimodal AI ecosystem.  
...
- [MMSearch-R1: Incentivizing LMMs to Search](https://arxiv.org/pdf/2506.20670) – 25 Jun 2025 - MMSearch-R1 is a novel framework that enables large multimodal models to efficiently conduct on-demand searches across text and images in real-world settings.
- [MMSearch-R1: Incentivizing LMMs to Search](https://arxiv.org/pdf/2506.20670) – 25 Jun 2025 - MMSearch-R1 introduces a novel reinforcement learning framework that equips large multimodal models to efficiently perform on-demand searches across images and text in real-world scenarios.
- [MMSearch-R1: Incentivizing LMMs to Search](https://arxiv.org/pdf/2506.20670) – 25 Jun 2025 - MMSearch-R1 is an innovative framework that empowers large multimodal models to efficiently conduct on-demand searches by integrating image and text retrieval, significantly enhancing their performance on complex know…
- [MMSearch-R1 introduces a novel end-to-end reinforcement learning framework that empowers large multimodal models (LMMs) to efficiently conduct multi-turn searches in dynamic real-world scenarios](https://arxiv.org/pdf/2506.20670>) – 25 Jun 2025 - MMSearch-R1 introduces a novel end-to-end reinforcement learning framework that empowers large multimodal models (LMMs) to efficiently conduct multi-turn searches in dynamic real-world scenarios.
- [MMSearch-R1: Incentivizing LMMs to Search](https://arxiv.org/pdf/2506.20670) – 25 Jun 2025 - MMSearch-R1 is a pioneering framework that enables large multimodal models to efficiently conduct multi-turn searches for information by integrating both image and text searches, thereby enhancing their ability to han…
...
- [Gemini Robotics On-Device brings AI to local robotic devices - Google DeepMind](https://deepmind.google/discover/blog/gemini-robotics-on-device-brings-ai-to-local-robotic-devices/) – 24 June 2025 - Gemini Robotics On-Device introduces an advanced AI model designed to run locally on robotic devices, enabling efficient and reliable performance without relying on internet connectivity.
- [The text indicates that the requested webpage is not accessible, suggesting a navigation issue](https://deepmind.google/discover/blog/gemini-robotics-on-device-brings-ai-to-local-robotic-devices/>) – 06 Jul 2025 - The text indicates that the requested webpage is not accessible, suggesting a navigation issue.
- [The page you were trying to access is unavailable, indicating a potential error with the link or content](https://deepmind.google/discover/blog/gemini-robotics-on-device-brings-ai-to-local-robotic-devices/>) – 06 Jul 2025 - The page you were trying to access is unavailable, indicating a potential error with the link or content.
- [Gemini Robotics On-Device brings AI to local robotic devices - Google DeepMind](https://deepmind.google/discover/blog/gemini-robotics-on-device-brings-ai-to-local-robotic-devices/) – 24 June 2025 - Gemini Robotics On-Device is a new AI model designed for robotic devices that enables efficient, localized task performance and rapid adaptation to new tasks without relying on data networks.
- [I'm unable to provide a summary as there was no text supplied for analysis](https://deepmind.google/discover/blog/gemini-robotics-on-device-brings-ai-to-local-robotic-devices/) – 02 Jul 2025 - I'm unable to provide a summary as there was no text supplied for analysis.
- [Gemini Robotics On-Device brings AI to local robotic devices - Google DeepMind](https://deepmind.google/discover/blog/gemini-robotics-on-device-brings-ai-to-local-robotic-devices/) – 24 June 2025 - Gemini Robotics On-Device introduces an advanced AI model designed for local robotic devices, allowing for efficient task adaptation and dexterity without relying on internet connectivity.
